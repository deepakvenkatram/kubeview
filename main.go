...
func (m model) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case tea.WindowSizeMsg:
		...
		m.podCPUChart.SetSize(msg.Width, (msg.Height-verticalMarginHeight)/4)
		m.podMemoryChart.SetSize(msg.Width, (msg.Height-verticalMarginHeight)/4)
		m.nodeCPUChart.SetSize(msg.Width, (msg.Height-verticalMarginHeight)/4)
		m.nodeMemoryChart.SetSize(msg.Width, (msg.Height-verticalMarginHeight)/4)
	case tickMsg:
		switch m.view {
		case viewNodes:
